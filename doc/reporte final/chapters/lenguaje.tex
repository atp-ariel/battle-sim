...
\begin{itemize}
	...
	\item Las funciones y las variables no pueden compartir nombre
	\item Una variable puede ser declarada tantas veces como se desee, siempre que no cambie el tipo que se le atribuyó la primera vez
	...
	\item Una vez definida una funci\'on no se puede definir otra vez
	\item Una funci\'on no puede tener distintas definiciones
	...
	\item Dos argumentos en una funci\'on no deben tener el mismo tipo
	\item Los m\'etodos de la clase deben tener como primer argumento un miembro de la clase
