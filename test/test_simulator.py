...
def test_simulator():
    ...
    # Units creation
    for i in range(10):
        s1.add_unit(LandUnit(i+1,r(1,10),r(1,10),s1,r(1,10),r(1,10),r(1,10),r(1,10),r(1,1),r(1,2),1,r(1,10),0,True,True))
        s1.units[-1].put_in_cell(maps, 0, i)

    for i in range(10):
        s2.add_unit(LandUnit(i+10+1,r(1,10),r(1,10),s2,r(1,10),r(1,10),r(1,10),r(1,10),r(1,1),r(1,2),1,r(1,10),0,True,True))
